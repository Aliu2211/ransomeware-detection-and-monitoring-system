...
# Check for python-dotenv and load environment variables
try:
...
class RansomwareDetectionSystem:
    ...
    def _init_components(self):
        ...
        try:
            ...
            # Train model if auto_train is enabled and not trained
    ...
    def stop(self):
        ...
        if hasattr(self, 'system_monitor'):
            ...
            self.system_monitor.save_metrics(metrics_path)
...
def main():
    ...
    try:
        ...
        if args.safe_dirs:
            ...
            safe_dirs = [d for d in [documents_dir, desktop_dir, download_dir] if os.path.exists(d)]
            if safe_dirs:
